...
Shipit.prototype.initSshPool = function () {
  ...
  var proxy = _.isString(this.config.proxy) ? this.config.proxy : null;
  this.pool = new sshPool.ConnectionPool(servers, proxy, _.extend({}, this.options, _.pick(this.config, 'key', 'strict')));
  return this;
};
